function [vac_ID_nn_set,vac_ID_count_set,vac_mig_sortID_nn_set,vac_mig_nn_count_set,relative_vac_coords] ...
    = update_vac_nn_kmc(vac_ID,mig_ID,per_coords,lattice_constant,supersize)
% Description:
...
for num_unique = 1:largest_nn
    ...
    % vac-mig 
%    inter_vac_mig = intersect(index_vac_set,index_mig_set);
%    mig_diff= setdiff(index_mig_set,inter_vac_mig);
%    test_vac_mig =[index_vac_set;mig_diff];
