...
%% Descrition:
% transfer the coordina
%super_size_length:
% NN_ML: this is the sortes to the new coordinates with the Mig-Vac vector as x axis, the vertical vac-NN1-atom
...
% lattice_constant:ted atomIDs which contains the NN atoms both from
